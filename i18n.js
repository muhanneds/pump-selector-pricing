...
const STRINGS = {
  en: {
    ...
    zoomFull:'Full size', zoomFit:'Fit page', nemaColumn:'Suction / NEMA',
  ...
  tr: {
    ...
    zoomFull:'Tam boyut', zoomFit:'Sayfaya sığdır', nemaColumn:'Emme / NEMA',
  ...
  ar: {
    ...
    zoomFull:'الحجم الكامل', zoomFit:'ملء الصفحة', nemaColumn:'السحب / NEMA',
  ...
  es: {
    ...
    zoomFull:'Tamaño real', zoomFit:'Ajustar', nemaColumn:'Succión / NEMA',
