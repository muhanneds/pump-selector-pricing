...
const STRINGS = {
  en: {
    ...
    designHead:'Design head {h} m · {ls} L/s', modelsIn:'{n} models in {tag}',
    ...
    enterQH:'Enter Q and H', bore:'Bore', freq:'Freq',
    flowQUnit:'Flow Q (m³/h)', headHUnit:'Head H (m)',
  ...
  tr: {
    ...
    frequency:'Frekans',
    flowQ:'Debi Q', headH:'Basma yüksekliği H', safety:'Güvenlik payı',
    designHead:'Tasarım yüksekliği {h} m · {ls} L/s', modelsIn:'{tag} serisinde {n} model',
    ...
    enterQH:'Q ve H girin', bore:'Kuyu', freq:'Frekans',
    flowQUnit:'Debi Q (m³/h)', headHUnit:'Basma yüksekliği H (m)',
  ...
  ar: {
    ...
    designHead:'رفع التصميم {h} m · {ls} L/s', modelsIn:'{n} موديل في {tag}',
    ...
    enterQH:'أدخل Q و H', bore:'البئر', freq:'التردد',
    flowQUnit:'التدفق Q (m³/h)', headHUnit:'الرفع H (m)',
  ...
  es: {
    ...
    flowQ:'Caudal Q', headH:'Altura H', safety:'Margen de seguridad',
    designHead:'Altura de diseño {h} m · {ls} L/s', modelsIn:'{n} modelos en {tag}',
    ...
    enterQH:'Ingrese Q y H', bore:'Pozo', freq:'Frec.',
    flowQUnit:'Caudal Q (m³/h)', headHUnit:'Altura H (m)',
