...
const STRINGS = {
  en: {
    ...
    enterQH:'Enter Q and H', enteredDuty:'Q={q} {u} · H={h} m', bore:'Bore', freq:'Freq',
    flowQUnit:'Flow Q', headHUnit:'Head H (m)',
  ...
  tr: {
    ...
    enterQH:'Q ve H girin', enteredDuty:'Q={q} {u} · H={h} m', bore:'Kuyu', freq:'Frekans',
    flowQUnit:'Debi Q', headHUnit:'Basma yüksekliği H (m)',
  ...
  ar: {
    ...
    enterQH:'أدخل Q و H', enteredDuty:'Q={q} {u} · H={h} m', bore:'البئر', freq:'التردد',
    flowQUnit:'التدفق Q', headHUnit:'الرفع H (m)',
  ...
  es: {
    ...
    enterQH:'Ingrese Q y H', enteredDuty:'Q={q} {u} · H={h} m', bore:'Pozo', freq:'Frec.',
    flowQUnit:'Caudal Q', headHUnit:'Altura H (m)',
