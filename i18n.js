...
const STRINGS = {
  en: {
    ...
    docLanguage:'Document', stampSignature:'Stamp & signature', docFlowUnit:'Flow',
    ...
    custDetails:'Customer details', custEmpty:'Tap to add the buyer',
    custApplicant:'Applicant', custApplicantPh:'Buyer name',
    custAddress:'Applicant address', custAddressPh:'Buyer address',
    custTel:'Tel', custEmail:'E-mail', custPiNo:'Proforma no', custDate:'Date',
    custTerms:'Terms', custPayment:'Payment term',
    custDelivery:'Delivery time', custShipment:'Shipment terms',
  ...
  tr: {
    ...
    docLanguage:'Belge dili', stampSignature:'Kaşe ve imza', docFlowUnit:'Debi',
    kpiLines:'Satır', kpiUnits:'Adet', kpiSaved:'İskonto',
    summaryNote:'İç teklif özeti — proforma fatura değildir.',
    nemaColumn:'Emme / NEMA',
    custDetails:'Müşteri bilgileri', custEmpty:'Alıcıyı eklemek için dokunun',
    custApplicant:'Alıcı', custApplicantPh:'Alıcı adı',
    custAddress:'Alıcı adresi', custAddressPh:'Alıcı adresi',
    custTel:'Tel', custEmail:'E-posta', custPiNo:'Proforma no', custDate:'Tarih',
    custTerms:'Koşullar', custPayment:'Ödeme şekli',
    custDelivery:'Teslim süresi', custShipment:'Teslim şekli',
  ...
  ar: {
    ...
    docLanguage:'لغة المستند', stampSignature:'الختم والتوقيع', docFlowUnit:'التدفق',
    kpiLines:'البنود', kpiUnits:'الكمية', kpiSaved:'الخصم',
    summaryNote:'ملخص عرض سعر داخلي — ليس فاتورة مبدئية.',
    nemaColumn:'السحب / NEMA',
    custDetails:'بيانات العميل', custEmpty:'اضغط لإضافة المشتري',
    custApplicant:'المشتري', custApplicantPh:'اسم المشتري',
    custAddress:'عنوان المشتري', custAddressPh:'عنوان المشتري',
    custTel:'هاتف', custEmail:'البريد الإلكتروني', custPiNo:'رقم الفاتورة', custDate:'التاريخ',
    custTerms:'الشروط', custPayment:'شروط الدفع',
    custDelivery:'مدة التسليم', custShipment:'شروط الشحن',
  ...
  es: {
    ...
    docLanguage:'Documento', stampSignature:'Sello y firma', docFlowUnit:'Caudal',
    ...
    custDetails:'Datos del cliente', custEmpty:'Toque para añadir el comprador',
    custApplicant:'Solicitante', custApplicantPh:'Nombre del comprador',
    custAddress:'Dirección', custAddressPh:'Dirección del comprador',
    custTel:'Tel', custEmail:'Correo', custPiNo:'N.º proforma', custDate:'Fecha',
    custTerms:'Condiciones', custPayment:'Forma de pago',
    custDelivery:'Plazo de entrega', custShipment:'Condiciones de envío',
