...
const STRINGS = {
  en: {
    ...
    zoomFull:'Full size', zoomFit:'Fit page',
  ...
  tr: {
    ...
    zoomFull:'Tam boyut', zoomFit:'Sayfaya sığdır',
  ...
  ar: {
    ...
    zoomFull:'الحجم الكامل', zoomFit:'ملء الصفحة',
  ...
  es: {
    ...
    zoomFull:'Tamaño real', zoomFit:'Ajustar',
